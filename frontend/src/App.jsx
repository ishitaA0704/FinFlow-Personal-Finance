  ...
  return (
    ...
    >
      ...
      >
        <div 
          style={{ 
            padding: isMobile ? "0 10px" : "0 16px 24px", 
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            ...
            {!collapsed && (
              <div>
                <div style={{ fontSize: 13, fontWeight: 800, color: C.text, lineHeight: 1 }}>FinFlow</div>
          ...
          {NAV.map(n => (
            <button 
              ...
              style={{
                ...
                boxShadow: page === n.id ? "0 0 12px rgba(240, 223, 20, 0.35)" : "none", 
      ...
      {/* Main Container Layer — minWidth: 0 prevents child elements like charts from expanding it horizontally */}
      <div 
        style={{ 
          flex: 1, 
          width: "100%", 
      ...
      >
        ...
        {/* Scroll Content Viewport Layer — overflowX and maxWidth keep the nested grid contents responsive */}
        <main 
          style={{ 
            flex: 1, 
            overflowY: "auto",     
